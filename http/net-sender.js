...
const socket = net.createConnection({ host: "localhost", port: 8050 }, () => {
  ...
  const head = Buffer.from(
    "",
    "hex"
  );

  const body = Buffer.from(
    "7b227469746c65223a225469746c65206f66206d7920706f7374222c22626f6479223a2254686973206973206d79207465787420616e64206d6f726520616e64206d6f72652e227d",
    "hex"
  );
...
// //// --------------------------------------------------  Byte and ASCHII Dump for Binary headline and Header
...
// 0080   67 74 68 3a 20 37 32 0d 0a 0d 0a                  gth: 72....

// // Byte and ASCHII Dump
...
//   0020   79 22 3a 22 54 68 69 73 20 69 73 20 6d 79 20 74   y":"This is my t
//   0030   65 78 74 20 61 6e 64 20 6d 6f 72 65 20 61 6e 64   ext and more and
//   0040   20 6d 6f 72 65 2e 22 7d                            more." }

// // Binary for Headline and Header

// 

// // Binary for Actual Data
